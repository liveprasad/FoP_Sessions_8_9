...
3. **Practice problems (each session)**  
   - **Session 8:** Section 4 (feedback) + 5.1–5.2 = in-class; 5.3–5.6 = homework (KPI tuple, unique schemes, district lookup, totals per scheme, satisfaction survey, milestones).  
